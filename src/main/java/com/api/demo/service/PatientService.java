...
public class PatientService {
   ...
   @Autowired
    ...
    public Long createPatient(CreatePatientRequest req) {
        ...
        try {
            ...
            String duplicateResult = patientCheckService.checkPatientDuplicate(
                req.getFirstNameEn(),
                req.getFatherNameEn(),
                req.getGrandfatherNameEn(),
                req.getLastNameEn(),
                req.getMobile(),
                Timestamp.valueOf(req.getDateOfBirth().atStartOfDay())
            );
    ...
    private void validateRequiredFields(CreatePatientRequest req) {
        ...
        if (req.getMobile() == null || req.getMobile().trim().isEmpty()) {
            ...
            // Validate mobile number format (Jordanian format: starts with 07 or 079)
            String mobile = req.getMobile().trim();
            if (!mobile.matches("^07[0-9]{8}$") && !mobile.matches("^079[0-9]{7}$")) {
                errors.append("Mobile Phone must be a valid Jordanian number (10 digits starting with 07). ");
            }
        }
    ...
    private static class PatientName {
        ...
        public String getFilterNameAr() { return filterNameAr; }
        public String getFilterNameEn() { return filterNameEn; }
    }
   ...
   @Transactional
    ...
    private void trimStringFields(UpdatePatientRequest req) {
        if (req.getFirstNameAr() != null) req.setFirstNameAr(req.getFirstNameAr().trim());
        if (req.getFirstNameEn() != null) req.setFirstNameEn(req.getFirstNameEn().trim());
        if (req.getFatherNameAr() != null) req.setFatherNameAr(req.getFatherNameAr().trim());
        if (req.getFatherNameEn() != null) req.setFatherNameEn(req.getFatherNameEn().trim());
        if (req.getGrandfatherNameAr() != null) req.setGrandfatherNameAr(req.getGrandfatherNameAr().trim());
        if (req.getGrandfatherNameEn() != null) req.setGrandfatherNameEn(req.getGrandfatherNameEn().trim());
        if (req.getLastNameAr() != null) req.setLastNameAr(req.getLastNameAr().trim());
        if (req.getLastNameEn() != null) req.setLastNameEn(req.getLastNameEn().trim());
        if (req.getMobile() != null) req.setMobile(req.getMobile().trim());
        if (req.getEmail() != null) req.setEmail(req.getEmail().trim());
        if (req.getAddress() != null) req.setAddress(req.getAddress().trim());
        if (req.getPlaceOfBirth() != null) req.setPlaceOfBirth(req.getPlaceOfBirth().trim());
        if (req.getNationalNo() != null) req.setNationalNo(req.getNationalNo().trim());
    }
    ...
    private void checkPatientDuplicateForUpdate(Long patientId, UpdatePatientRequest req, 
        ...
        try {
            ...
            String grandfatherName = req.getGrandfatherNameEn() != null ? req.getGrandfatherNameEn() : patient.getGrandfatherNameE();
    ...
    private void updateFullNames(PatientEntity patient) {
        ...
        String fullNameAr = String.join(" ",
            ...
            patient.getLastNameA() != null ? patient.getLastNameA() : ""
        ).trim().replaceAll("\\s+", " ");
        ...
        String fullNameEn = String.join(" ",
            ...
            patient.getLastNameE() != null ? patient.getLastNameE() : ""
        ).trim().replaceAll("\\s+", " ");
